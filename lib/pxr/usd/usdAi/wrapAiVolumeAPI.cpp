...
static UsdAttribute
_CreateAiVolumePaddingAttr(UsdAiVolumeAPI &self,
                                      object defaultVal, bool writeSparsely) {
    return self.CreateAiVolumePaddingAttr(
...
void wrapUsdAiVolumeAPI()
{
    typedef UsdAiVolumeAPI This;
    ...
    cls
        ...
        .def("GetAiVolumePaddingAttr",
             &This::GetAiVolumePaddingAttr)
        .def("CreateAiVolumePaddingAttr",
             &_CreateAiVolumePaddingAttr,
