...
UsdAiTokensType::UsdAiTokensType() :
    ...
    aiCompress("ai:compress", TfToken::Immortal),
    ...
    aiStep_scale("ai:step_scale", TfToken::Immortal),
    aiStep_size("ai:step_size", TfToken::Immortal),
    ...
    aiVelocity_fps("ai:velocity_fps", TfToken::Immortal),
    aiVelocity_outlier_threshold("ai:velocity_outlier_threshold", TfToken::Immortal),
    aiVelocity_scale("ai:velocity_scale", TfToken::Immortal),
    ...
    aiVolume("ai:volume", TfToken::Immortal),
    aiVolume_padding("ai:volume_padding", TfToken::Immortal),
    ...
    elemType("elemType", TfToken::Immortal),
    ...
    nodeType("nodeType", TfToken::Immortal),
