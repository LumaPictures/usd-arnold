...
static const TfToken varNamePrefixed1(UsdAiTokens->userPrefix.GetString() + varName1.GetString());
static const TfToken varNamePrefixed2(UsdAiTokens->userPrefix.GetString() + varName2.GetString());
static const TfToken varNamePrefixed3(UsdAiTokens->userPrefix.GetString() + varName3.GetString());
